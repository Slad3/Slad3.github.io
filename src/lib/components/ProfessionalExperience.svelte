<script lang="ts">
	const experience = [
        {
			title: 'Assoc Software Development Engineer',
			experience: 'Full Time',
			place: 'NextEra Analytics',
			image: '',
			imageCredit: 'Image credit to NextEra Analytics',
			date: 'July 2022 - April 2024',
			description: [

			],
			skills: ["Python", "Vue", "TypeScript", "SQL", "PostgresSQL","FastAPI/Flask", "Leaflet", "Pandas", "GitLab", "GitHub", "Plotly (Python and JS)"]
		},
		{
			...
			skills: ['TypeScript', 'AWS Lambda', 'MongoDB', 'AWS SQS', 'Serverless']
		},
		{
			title: 'Software Engineer Intern',
			experience: 'Internship',
